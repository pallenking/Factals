...
//	Leaf(.splitter, [n:"e"]),		Leaf(.genSplitter, [n:"f"]),
  ...
  Net([placeMy:"stackz -1 -1", parts:[
	Leaf(.prev, 	[n:"t"]),		Leaf(.genPrev, 	[n:"r"]),	Leaf(.flipPrev, [n:"s"]),
  ] ]),
  Net([placeMy:"stackz -1 -1", parts:[
...
r("+ Generate AppIcon", e + camera(h:0,s:10,u:10,z:1) + velX(-9) + ["gapLinkFluff":3], {Net([placeMy:"linky", parts:[	//stacky
	...
	xr("- Port Missing", e + camera(h:0,s:-48,u:-10) + velX(-9) + ["gapLinkFluff":3], {Net([placeMy:"linky", parts:[	//stacky
		MaxOr([f:1]),
		Hamming([n:"a",  f:1]),
	]]) })
