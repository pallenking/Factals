...
////
//// https://stackoverflow.com/questions/65379307/swiftui-macos-nswindow-instance
//
//import Cocoa
//
...
////	}
//
//	func applicationDidFinishLaunching(_ aNotification: Notification) { bug
...
//	}
//
//	@objc func orderFrontStandardAboutPanel(_ sender: Any?) {			bug
//		let val : Any? = nil						// PW: eliminate this line
////		let val : (Any)? = nil						// PW: eliminate this line
...
//
//	@objc
//	func application(_ application: NSApplication, open urls: [ URL ]) {bug
