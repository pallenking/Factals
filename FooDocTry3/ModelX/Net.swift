...
////		super.init(["placeMy":"linkx"] + config)	//\/\/\/\/\/\/\/\/\/\/\/\/\/
...
//		let theCopy : Net		= super.copy(with:zone) as! Net
...
//
//	 // MARK: - 3.7 Equitable
//	func varsOfNetEq(_ rhs:Part) -> Bool {
//		guard let rhsAsNet		= rhs as? Net else {		return false		}
//		return minSize			== rhsAsNet.minSize
//	}
//	override func equalsPart(_ part:Part) -> Bool {
//		return	super.equalsPart(part) && varsOfNetEq(part)
//	}
//
