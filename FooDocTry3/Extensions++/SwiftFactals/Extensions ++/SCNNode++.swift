 //  SCN++.swift -- Customization of SceneKit C2018PAK
...
extension SCNNode {	// : not Codable	// : ObservableObject
...
//	var hasActions: Bool				// A Boolean value that indicates whether the node is currently executing any actions.
//	var actionKeys: [String] 			// The list of keys for which the node has attached actions.
//	func removeAction(forKey: String){}	// Removes an action associated with a specific key.
//	func removeAllActions()			{}	// Ends and removes all actions from the node.
//	func action(forKey: String) {
//		print("\n\n" + "### func action(forKey:\(forKey)\n\n")
//		action(forKey:forKey)
//	}
