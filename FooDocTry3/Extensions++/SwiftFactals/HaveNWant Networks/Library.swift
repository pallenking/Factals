...
class Library : NSObject {
	...
	static func library(fromSelector s:String?, fwDocument:FwDocument?) -> Library? {
...
//				answer.ansFile		= file
	...
	override var description	  : String 	{	return  "\"\(fwClassName) \(name)\""	}
	override var debugDescription : String	{	return   "'\(fwClassName) \(name)'"		}
...
func log(prefix:String="",
		  ...
		  rve:Int=0, rsi:Int=0, rnd:Int=0, ani:Int=0, ins:Int=0, all:Int=0) -> FwConfig {
